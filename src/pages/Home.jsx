...
import { FiBriefcase, FiCode, FiArrowRight, FiFileText, FiLayers, FiBarChart2, FiBookOpen } from 'react-icons/fi';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white font-sans selection:bg-blue-500 selection:text-gray-900 dark:text-white overflow-x-hidden transition-colors duration-300">
      ...
      {/* Features Grid */}
      <div id="features" className="max-w-7xl mx-auto mt-32 px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            {
              icon: <FiBookOpen className="w-6 h-6 text-violet-600 dark:text-violet-400" />,
            ...
            {
              icon: <FiFileText className="w-6 h-6 text-amber-600 dark:text-amber-400" />,
