 ...
 */
export const supportsDocuments = (category?: string | null): boolean => {
...
export const isActiveInternshipStatus = (status?: string | null) =>
 ...
 */
export const getDocumentUnavailableMessage = (category?: string | null): string | null => {
...
export const getCampusModeLabel = (mode?: string | null): string | null => {
 ...
 */
export const calculateCampusModeStats = (opportunities: Opportunity[] = []) => {
...
export const filterByCampusMode = (
    opportunities: Opportunity[] = [],
    campusModeFilter: CampusMode | 'all' = 'all'
) => {
